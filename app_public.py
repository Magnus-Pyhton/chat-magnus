...
try:
    ...
    st.sidebar.markdown(f"### 🌐 Öffentliche URL")
    st.sidebar.markdown(f"[{public_url.public_url}]({public_url.public_url})")
    st.sidebar.markdown("Diese URL funktioniert von überall!")
except Exception as e:
    st.sidebar.warning(f"ngrok konnte nicht gestartet werden: {e}")
